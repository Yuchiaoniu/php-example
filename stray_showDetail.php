                        ...
                        ?>
                            ...
                            <ul class="big-image-list">
                                <li>
                                    ...
                                    <h2>遺失案件編號：stray <?php echo $row['id'] ?>
                                        <br> 建立日期： <?php $row['date'] ?>
                                    </h2>
                                    <span class="label label-info"> <?php echo $row['type'] ?>
                                    </span> <br><br>
                            ...
                            <div>
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapsefour"> 外觀特徵</a>
                                    </h4>
                                </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapsefive"> 聯絡方式</a>
                                </h4>
                            </div>

                            <div id="collapsefive" class="panel-collapse collapse">
                                <div class="panel-body"> <?php echo $row['contact'] ?>
                                </div>
                            </div>
                        <?php }
