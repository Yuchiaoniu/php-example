                                ...
                                <div class="card" id="dog" style="margin-left: 10%;">
                                    <div class=" row">
                                        ...
                                        <div class="col-3" style="margin-top: 12pt">
                                            <form method="post" action="rescueFormEdit.php">

                                                <input style="display: none;" type="text" name="rescueID" value="<?PHP echo     $row2->id ?>">

                                                <input  class="btn btn-outline-dark" type="submit" value="修改個案">
                                            ...
                                            <form method="post" action="rescue_delete.php">
                                                ...
                                                <input  class="btn btn-outline-dark" onclick="return del()" type="submit" value="刪除個案">
