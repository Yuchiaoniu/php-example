...
<head>
	...
	<script type="text/javascript">
		function check_data() {
			...
			if (document.rescueForm.amount.value.length > 255 | document.rescueForm.amount.value == 0) {
	...
	<div id="page-wrapper">
		...
		<form action="rescueFormUpdate.php" name="rescueForm" method="post" enctype="multipart/form-data" style="background-color: rgba(220, 220, 220, 0.534)" class="px-auto container col-6">
			...
			<div class="form-group">
				...
				<input class="btn btn-primary" type="submit" onclick="return check_data()" value="確認送出">
			</div>
		</form>
